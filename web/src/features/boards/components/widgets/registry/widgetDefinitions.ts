...
import { WidgetConfig, WidgetContext } from '@/features/boards/components/types'
import { getWidgetSize } from '@/features/boards/components/utils/widgetConstraints'

// Import all widget components
import MetricWidget from '@/features/boards/components/widgets/metric/MetricWidget'
import TotalReturnWidget from '@/features/boards/components/widgets/metric/TotalReturnWidget'
import WinRateWidget from '@/features/boards/components/widgets/metric/WinRateWidget'
import GoalTrackerWidget from '@/features/boards/components/widgets/metric/GoalTrackerWidget'
import RiskMetricWidget from '@/features/boards/components/widgets/metric/RiskMetricWidget'
import BenchmarkMetricWidget from '@/features/boards/components/widgets/metric/BenchmarkMetricWidget'
import HoldingPeriodWidget from '@/features/boards/components/widgets/metric/HoldingPeriodWidget'
import BitcoinPizzaWidget from '@/features/boards/components/widgets/metric/BitcoinPizzaWidget'
import SentimentWidget from '@/features/boards/components/widgets/metric/SentimentWidget'
import VIXWidget from '@/features/boards/components/widgets/metric/VIXWidget'
import TNXWidget from '@/features/boards/components/widgets/metric/TNXWidget'
import DXYWidget from '@/features/boards/components/widgets/metric/DXYWidget'
import NotificationsWidget from '@/features/boards/components/widgets/list/NotificationsWidget'
import WatchlistWidget from '@/features/boards/components/widgets/list/WatchlistWidget'
import PositionsTableWidget from '@/features/boards/components/widgets/list/PositionsTableWidget'
import RecentTransactionsWidget from '@/features/boards/components/widgets/list/RecentTransactionsWidget'
import ConcentrationRiskWidget from '@/features/boards/components/widgets/analysis/ConcentrationRiskWidget'
import BestWorstTodayWidget from '@/features/boards/components/widgets/analysis/BestWorstTodayWidget'
import TopPerformersWidget from '@/features/boards/components/widgets/analysis/TopPerformersWidget'
import WorstPerformersWidget from '@/features/boards/components/widgets/analysis/WorstPerformersWidget'
import LargestHoldingsWidget from '@/features/boards/components/widgets/analysis/LargestHoldingsWidget'
import PerformanceMetricsWidget from '@/features/boards/components/widgets/analysis/PerformanceMetricsWidget'
import TodayBriefWidget from '@/features/boards/components/widgets/analysis/TodayBriefWidget'
import AssetAllocationWidget from '@/features/boards/components/widgets/analysis/AssetAllocationWidget'
import ThemeAllocationWidget from '@/features/boards/components/widgets/analysis/ThemeAllocationWidget'
import PortfolioHeatmapWidget from '@/features/boards/components/widgets/analysis/PortfolioHeatmapWidget'
import MarketStatusWidget from '@/features/boards/components/widgets/market/MarketStatusWidget'
import MarketIndicesWidget from '@/features/boards/components/widgets/market/MarketIndicesWidget'
import { calculateHitRatio, calculateDiversificationScore } from '@/features/boards/components/widgets/utils/metricsCalculations'
