...
import api from '@/api'
import { formatCurrency as formatCurrencyUtil } from '@/shared/lib/formatUtils'
...
export default function TransactionHistory({ assetId, assetSymbol, portfolioId, portfolioCurrency = 'USD', onClose }: TransactionHistoryProps) {
  ...
  return (
    <div className="pf-modal-overlay">
      <div className="pf-modal-panel pf-modal-panel--xl h-[90vh] max-w-6xl" role="dialog" aria-modal="true">
        {/* Header */}
        ...
        {/* Content */}
        <div className="pf-modal-body overflow-hidden">
          {loading ? (
            ...
            <div className="flex h-full min-h-0 flex-col gap-5">
              ...
              {/* Transaction Table */}
              <div className="min-h-0 flex-1 overflow-auto border border-neutral-200 dark:border-neutral-700 rounded-lg">
