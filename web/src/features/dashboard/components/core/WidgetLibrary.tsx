...
import { getWidgetsGroupedByCategory } from '@/features/dashboard/components/widgets/registry'
import { generateWidgetInstanceId } from '@/features/dashboard/components/utils/widgetUtils'
import { WidgetConfig, WidgetCategory } from '@/features/dashboard/components/types'
import { saveLayout, loadLayout } from '@/features/dashboard/components/utils/defaultLayouts'
import ConfirmModal from '@/shared/components/ConfirmModal'
import { WidgetGallery } from '@/features/dashboard/components/core/WidgetGallery'
import { useTranslation } from 'react-i18next'
import { getCategoryLabel } from '@/features/dashboard/components/widgets/registry/categories'
import { MockDataProvider, mockMetrics, mockPositions } from '@/features/dashboard/components/utils/mockDataProvider'
