...
import { WidgetConfig } from '@/features/dashboard/components/types'
import { isWidgetInstance } from '@/features/dashboard/components/utils/widgetUtils'
import { WidgetPreview } from '@/features/dashboard/components/widgets/base/WidgetPreview'
