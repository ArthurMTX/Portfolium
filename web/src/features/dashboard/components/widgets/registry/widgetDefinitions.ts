...
import { WidgetConfig, WidgetContext } from '@/features/dashboard/components/types'
import { getWidgetSize } from '@/features/dashboard/components/utils/widgetConstraints'

// Import all widget components
import MetricWidget from '@/features/dashboard/components/widgets/metric/MetricWidget'
import TotalReturnWidget from '@/features/dashboard/components/widgets/metric/TotalReturnWidget'
import WinRateWidget from '@/features/dashboard/components/widgets/metric/WinRateWidget'
import GoalTrackerWidget from '@/features/dashboard/components/widgets/metric/GoalTrackerWidget'
import RiskMetricWidget from '@/features/dashboard/components/widgets/metric/RiskMetricWidget'
import BenchmarkMetricWidget from '@/features/dashboard/components/widgets/metric/BenchmarkMetricWidget'
import HoldingPeriodWidget from '@/features/dashboard/components/widgets/metric/HoldingPeriodWidget'
import BitcoinPizzaWidget from '@/features/dashboard/components/widgets/metric/BitcoinPizzaWidget'
import SentimentWidget from '@/features/dashboard/components/widgets/metric/SentimentWidget'
import VIXWidget from '@/features/dashboard/components/widgets/metric/VIXWidget'
import TNXWidget from '@/features/dashboard/components/widgets/metric/TNXWidget'
import DXYWidget from '@/features/dashboard/components/widgets/metric/DXYWidget'
import NotificationsWidget from '@/features/dashboard/components/widgets/list/NotificationsWidget'
import WatchlistWidget from '@/features/dashboard/components/widgets/list/WatchlistWidget'
import PositionsTableWidget from '@/features/dashboard/components/widgets/list/PositionsTableWidget'
import RecentTransactionsWidget from '@/features/dashboard/components/widgets/list/RecentTransactionsWidget'
import ConcentrationRiskWidget from '@/features/dashboard/components/widgets/analysis/ConcentrationRiskWidget'
import BestWorstTodayWidget from '@/features/dashboard/components/widgets/analysis/BestWorstTodayWidget'
import TopPerformersWidget from '@/features/dashboard/components/widgets/analysis/TopPerformersWidget'
import WorstPerformersWidget from '@/features/dashboard/components/widgets/analysis/WorstPerformersWidget'
import LargestHoldingsWidget from '@/features/dashboard/components/widgets/analysis/LargestHoldingsWidget'
import PerformanceMetricsWidget from '@/features/dashboard/components/widgets/analysis/PerformanceMetricsWidget'
import TodayBriefWidget from '@/features/dashboard/components/widgets/analysis/TodayBriefWidget'
import AssetAllocationWidget from '@/features/dashboard/components/widgets/analysis/AssetAllocationWidget'
import ThemeAllocationWidget from '@/features/dashboard/components/widgets/analysis/ThemeAllocationWidget'
import PortfolioHeatmapWidget from '@/features/dashboard/components/widgets/analysis/PortfolioHeatmapWidget'
import MarketStatusWidget from '@/features/dashboard/components/widgets/market/MarketStatusWidget'
import MarketIndicesWidget from '@/features/dashboard/components/widgets/market/MarketIndicesWidget'
import { calculateHitRatio, calculateDiversificationScore } from '@/features/dashboard/components/widgets/utils/metricsCalculations'
