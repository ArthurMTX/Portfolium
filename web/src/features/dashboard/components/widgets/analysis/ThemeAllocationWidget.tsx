...
import { BaseWidget } from '@/features/dashboard/components/widgets/base/BaseWidget'
import { ViewAllButton } from '@/features/dashboard/components/widgets/base/ViewAllButton'
